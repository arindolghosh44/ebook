...
<div class="col-md-3">
<a href="cart.jsp" class="mt-1"><i class="fas fa-cart-plus fa-2x"></i></a>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <br>
       ...
       <br>
      <a  href="help.jsp" class="btn btn-light my-2 my-sm-0 ml-1" type="submit">
